# 📚 Funcionalidades da Área do Aluno

Este documento reúne duas funcionalidades importantes da plataforma:

- **Sistema de Agendamento de Provas Orais**
- **Aba de Ofertas na Área do Aluno**

Ambas têm como objetivo **melhorar a experiência do aluno** e **otimizar processos internos da plataforma**.
...
Esta funcionalidade consiste em um sistema que permite aos alunos **visualizar e agendar horários para provas orais**, com base na **disponibilidade dos professores**.

O objetivo é **automatizar e organizar o processo de agendamento**, facilitando a gestão para a equipe docente e oferecendo **mais autonomia e praticidade aos alunos**.
...
- Acessar a **lista de horários disponíveis** diretamente no site  
- Escolher um horário para **agendar sua prova oral de forma simples e rápida**
...
#### Modo 1 – Escolha do Professor

O aluno escolhe o horário **sabendo qual professor estará disponível**.

#### Modo 2 – Professor Automático

O professor é **escolhido automaticamente pelo sistema**, e o aluno seleciona apenas **um horário vago**.
...
Este documento descreve a implementação de uma funcionalidade que **já existia em uma versão anterior do site** e se mostrou **altamente útil para conversão de alunos em novas turmas**.

Atualmente, a área do aluno **não possui uma "Aba de Ofertas" na coluna de navegação**.  
A proposta consiste na criação dessa aba para disponibilizar **promoções especiais e exclusivas direcionadas aos alunos**.
...
- Exibir **lista de ofertas disponíveis** contendo:

  - Nome da turma  
  - Descrição resumida  
  - Valor promocional  
  - Botão de compra ou inscrição  
  - Prazo da oferta  
...
- Exibir **ofertas exclusivas por perfil ou grupo de alunos** (opcional)
- Controlar **validade das ofertas**
- Permitir **destaque de ofertas prioritárias**
...
- Apenas **administradores** podem criar ou editar ofertas
- A aba deve respeitar a **autenticação da área do aluno**
...
- Admin consegue **cadastrar, editar e remover ofertas**
