...
async function initLayout() {
    ...
    const settings = await loadSettings();
    const isAdmin = window.location.pathname.includes('admin.html') || localStorage.getItem('nevapro_is_admin') === 'true';
            ...
            <div class="sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="admin.html" class="nav-item ${window.location.pathname.includes('admin.html') ? 'active' : ''}">
                        <i data-lucide="shield-check" style="color: #0ea5e9"></i> Backoffice
                    </a>` : ''}
                </nav>
